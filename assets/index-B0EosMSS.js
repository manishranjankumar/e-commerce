...
const getProductById = (id) => {
  return getProducts().find((p2) => p2.id === id);
};
const saveProduct = (product) => {
  const products = getProducts();
  const index = products.findIndex((p2) => p2.id === product.id);
  if (index > -1) {
    product.createdAt = product.createdAt || products[index].createdAt || (/* @__PURE__ */ new Date()).toISOString();
...
const deleteProduct = (id) => {
  const products = getProducts().filter((p2) => p2.id !== id);
  localStorage.setItem(STORAGE_KEY, JSON.stringify(products));
};
const seedDummyProducts = () => {
  if (!localStorage.getItem(STORAGE_KEY)) {
    const dummy = [...Array(25)].map((_2, i) => ({
      id: v4(),
      name: `Product ${i + 1}`,
      ...
      createdAt: new Date(Date.now() - i * 1e7).toISOString()
    }));
...
function ProductList() {
  ...
  const handleDelete = (id) => {
    if (confirm("Are you sure you want to delete this product?")) {
      ...
      Q.success("Product deleted");
    }
  };
  if (!products.length) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-gray-500 mt-10", children: "No products available." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold", children: "Product List" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-4", children: products.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-4 rounded shadow space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: product.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "₹",
        product.price
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: product.category }),
...
const ProductDetail = () => {
  ...
  if (!product) return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/products", replace: true });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded shadow-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold mb-4", children: product.name }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Stock Count:" }),
      " ",
      product.stockCount
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/products/${product.id}/edit`, className: "mt-4 inline-block bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700", children: "Edit Product" })
  ] });
};
const ProductFormPage = () => {
  ...
  if (product === void 0) return /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/products", replace: true });
  ...
  const handleSubmit = (e) => {
    ...
    Q.success(isEditing ? "Product updated" : "Product added");
    navigate("/products");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4 max-w-xl mx-auto bg-white p-6 rounded shadow-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", name: "name", placeholder: "Name", value: product.name, onChange: handleChange, className: "border p-2 w-full rounded", required: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { name: "description", placeholder: "Description", value: product.description, onChange: handleChange, className: "border p-2 w-full rounded" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", name: "price", placeholder: "Price", value: product.price, onChange: handleChange, className: "border p-2 w-full rounded", required: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", name: "category", placeholder: "Category", value: product.category, onChange: handleChange, className: "border p-2 w-full rounded", required: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "number", name: "stockCount", placeholder: "Stock Count", value: product.stockCount, onChange: handleChange, className: "border p-2 w-full rounded" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", className: "bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700", children: [
      isEditing ? "Update" : "Add",
      " Product"
    ] })
  ] });
};
const NotFound = () => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-red-500 text-xl mt-20", children: "404 - Page Not Found" });
const App = () => {
  reactExports.useEffect(() => {
    seedDummyProducts();
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/products" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/products", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductList, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/products/new", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductFormPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/products/:id", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductDetail, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/products/:id/edit", element: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductFormPage, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "*", element: /* @__PURE__ */ jsxRuntimeExports.jsx(NotFound, {}) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(k, { position: "top-right", autoClose: 2e3 })
  ] });
};
